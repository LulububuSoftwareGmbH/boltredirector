...
Once you're all up and running, defining your 301-redirects is simple. Each redirect is stored the extension's `config.yml` file (`/extensions/vendor/foundry-code/bolt-redirector/config.yml`), under the `redirects` section. The syntax is as follows:
